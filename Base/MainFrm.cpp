...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_MainSplitter.CreateView(0, 1, RUNTIME_CLASS(CMisoToolView), CSize(WINCX, WINCY), pContext);
	m_SubSplitter.CreateView(0, 0, RUNTIME_CLASS(CMiniView), CSize(270, 200), pContext);
	m_SubSplitter.CreateView(1, 0, RUNTIME_CLASS(CMyForm), CSize(270, 200), pContext);

	m_pMainView = (CMisoToolView*)m_MainSplitter.GetPane(0, 1);
	m_pMiniView = (CMiniView*)m_SubSplitter.GetPane(0, 0);
	m_pMyForm = (CMyForm*)m_SubSplitter.GetPane(1, 0);

	m_MainSplitter.SetColumnInfo(0, 270, 10);
